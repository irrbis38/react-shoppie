        ...
        <div className="container">
          <div className="intro__wrapper">
            <div className="intro__description">
              ...
              <a href="./pages/products/products.html" className="intro__btn">
                SHOP NOW
              </a>
            </div>
            <div className="intro__image">
              ...
              <img
                ...
                src="https://images.unsplash.com/photo-1610492219815-f76905e3f084?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1974&q=80"
                alt="fruits and vegetables"
              />
              <img
                className="intro__second"
                src="https://images.unsplash.com/photo-1511448598600-c01f02a2ee95?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80"
                alt="fruits and vegetables"
              />
            </div>
          </div>
        ...
        <div className="container">
          <div className="latest__wrapper">
            ...
            <a
              ...
              className="intro__btn latest__btn"
            >
              ALL PRODUCTS
            </a>
          </div>
